...
print  ""
print "GroveWeatherPi Solar Powered Weather Station Version 2.95 - SwitchDoc Labs"
print ""
print ""
...
pclogging.log(pclogging.INFO, __name__, "GroveWeatherPi Startup Version 2.95")

subjectText = "The GroveWeatherPi Raspberry Pi has #rebooted."
ipAddress = commands.getoutput('hostname -I')
bodyText = "GroveWeatherPi Version 2.95 Startup \n"+ipAddress+"\n"
if (config.SunAirPlus_Present):
	sampleSunAirPlus()
